...
This repository is used to document **Denavit–Hartenberg (DH) frame placement** and **homogeneous transformation matrices** for multiple robots it was done in a team of 5.
